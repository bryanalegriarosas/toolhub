<template>
    <div class="min-h-screen bg-gray-100">
                ...
                <div class="hidden md:flex items-center gap-3" v-if="!$slots.sidebar">
                    <div class="relative">
                        ...
                        <input id="layout-search" v-model="search" @input="filterTools" type="text"
                            ...
                            class="border rounded-lg px-4 py-2 w-full md:w-64 focus:ring focus:ring-blue-200" />
                    </div>
                </div>
            </div>
        </header>
        ...
        <div v-show="mobileMenuOpen" class="md:hidden bg-white border-b px-6 py-4">
            ...
            <div class="mt-6" v-if="!$slots.sidebar && filteredTools.length > 0">
                ...
                <div class="max-h-64 overflow-y-auto">
                    ...
                    <div v-if="filteredTools.length > 10" class="mt-3 text-center">
                        <Link href="/tools" class="text-blue-600 hover:text-blue-700 text-sm font-medium"
                            @click="mobileMenuOpen = false">
                            View all tools →
                        </Link>
                    </div>
        ...
        <div class="flex max-w-7xl mx-auto mt-6 gap-6 px-6">
            <!-- SIDEBAR -->
            <aside v-if="!$slots.sidebar" class="hidden lg:block w-64 bg-white rounded-xl shadow p-4 h-fit">
                <h2 class="text-sm font-semibold text-gray-400 uppercase mb-3">
                    Tools
                </h2>
