<template>
    <Head>
        <meta name="description" content="Generate SEO meta tags with real-time preview, validation, and multiple tag support." />
    </Head>

    <div class="max-w-6xl mx-auto bg-white shadow-lg rounded-xl p-6 space-y-6">
        <h2 class="text-2xl font-bold">Meta Tag Generator</h2>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea 
                                v-model="description" 
                                @input="validateInputs"
                                placeholder="Enter your meta description (120-160 characters)"
                                maxlength="160"
                                rows="3"
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select v-model="robots" class="w-full px-3 py-2 border rounded-lg">
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select v-model="ogType" class="w-full px-3 py-2 border rounded-lg">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input 
                                ...
                                @input="validateInputs"
                                placeholder="Twitter card title (optional)"
                                maxlength="70"
                                class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                @input="validateInputs"
                                placeholder="Twitter card description (optional)"
                                maxlength="200"
                                rows="2"
                                class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
                            />
        ...
        <div v-if="result" class="space-y-6">
            <div class="bg-gray-50 rounded-lg p-6">
                ...
                <div class="bg-white rounded-lg p-4">
                    <pre class="text-sm text-gray-800 overflow-x-auto"><code>{{ result }}</code></pre>
                </div>
