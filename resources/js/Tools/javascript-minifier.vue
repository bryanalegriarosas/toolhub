<template>
    <div class="max-w-6xl mx-auto p-6 bg-white dark:bg-gray-800 shadow rounded-xl">
        ...
        <h1 class="text-2xl font-bold mb-4 text-gray-900 dark:text-white">JavaScript Minifier</h1>

        <div class="space-y-4">
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Input JavaScript</label>
                <textarea v-model="input" @input="onInputChange" class="w-full border p-3 rounded font-mono text-sm"
                    rows="8" placeholder="Paste your JavaScript code here..." />
            </div>
...
const faqs = [
    {
        ...
        answer: "JavaScript minification removes unnecessary characters from your code, including whitespace, comments, and formatting, without changing its functionality. This reduces file size and improves page load speed."
    },
    {
        question: "Is minified JavaScript still valid?",
        answer: "Yes, minified JavaScript remains completely valid and functional. The minification process only removes non-essential characters like spaces, line breaks, and comments."
    },
    {
    ...
    },
    {
        ...
        answer: "Compression varies depending on your JavaScript structure, but typically you can achieve 20-50% size reduction. Well-formatted code with lots of whitespace and comments will compress more."
    },
    {
