<template>
    <Head>
        <meta name="description" content="Generate XML sitemaps with validation, multiple URLs, and advanced options." />
    </Head>

    <div class="max-w-6xl mx-auto bg-white shadow-lg rounded-xl p-6 space-y-6">
        <h2 class="text-2xl font-bold">Sitemap Generator</h2>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="flex gap-2">
                                <input 
                                    v-model="singleUrl" 
                                    @keyup.enter="addSingleUrl"
                                    placeholder="Add single URL"
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select v-model="options.changeFreq" class="w-full px-3 py-2 border rounded-lg">
                        ...
                        <div>
                            ...
                            <select v-model="options.priority" class="w-full px-3 py-2 border rounded-lg">
                        ...
                        <div>
                            ...
                            <select v-model="options.lastMod" class="w-full px-3 py-2 border rounded-lg">
                        ...
                        <div>
                            <label class="flex items-center space-x-2">
                                <input 
                                    ...
                                    class="rounded"
                                />
                                <span class="text-sm font-medium text-gray-700">Validate URLs</span>
                            </label>
                        </div>
                    </div>
                </div>
        ...
        <div v-if="xml" class="space-y-6">
            <div class="bg-gray-50 rounded-lg p-6">
                ...
                <div class="bg-white rounded-lg p-4">
                    <pre class="text-sm text-gray-800 overflow-x-auto font-mono"><code>{{ xml }}</code></pre>
                </div>
                ...
                <div class="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    ...
                    <div class="text-center">
                        <div class="text-2xl font-bold text-green-600">{{ xmlSize }}</div>
                        <div class="text-gray-600">File Size</div>
                    </div>
                    <div class="text-center">
                        <div class="text-2xl font-bold text-purple-600">{{ validUrlCount }}</div>
                        <div class="text-gray-600">Valid URLs</div>
                    </div>
                    <div class="text-center">
                        <div class="text-2xl font-bold text-orange-600">{{ invalidUrlCount }}</div>
        ...
        <!-- Validation Messages -->
        <div v-if="validationErrors.length > 1" class="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg">
